module UnitsHelper
  ...
  def self.units
    ["B-AAAI", "B-AAAMC", "B-AFRIST", "B-ALF", "B-ANTH", "B-ARCHIVES", "B-ASTR", "B-ATHBASKM", "B-ATHBASKW", "B-ATHFHOCKEY", "B-ATHFTBL",
     "B-ATHROWING", "B-ATHSOCCM", "B-ATHSOFTB", "B-ATHTENNM", "B-ATHVIDEO", "B-ATHVOLLW", "B-ATM", "B-BCC", "B-BFCA", "B-BUSSPEA",
     "B-CAC", "B-CDEL", "B-CEDIR", "B-CELCAR", "B-CELTIE", "B-CEUS", "B-CHEM", "B-CISAB", "B-CLACS", "B-CMCL", "B-CREOLE", "B-CSHM",
     "B-CYCLOTRN", "B-EASC", "B-EDUC", "B-EPPLEY", "B-FACILITY", "B-FINEARTS", "B-FOLKETHNO", "B-FRANKLIN", "B-GBL", "B-GEOLOGY", "B-GLBTSSSL",
     "B-GLEIM", "B-GLOBAL", "B-HPER", "B-IAS", "B-IAUNRC", "B-IBHA", "B-IPRC", "B-IUAM", "B-IULMIA", "B-JOURSCHL", "B-KINSEY", "B-LACASA", "B-LAW",
     "B-LIBERIA", "B-LIFESCI", "B-LILLY", "B-LING", "B-MATHERS", "B-MDP", "B-MUSBANDS", "B-MUSIC", "B-MUSOPERA", "B-MUSREC", "B-OID",
     "B-OPTMSCHL", "B-OPTOMTRY", "B-POLISH", "B-PSYCH", "B-RECSPORTS", "B-REEI", "B-RTVS", "B-SAGE", "B-SAVAIL", "B-SWAIN", "B-TAI",
     "B-THTR", "B-UNDRWATR", "B-UNIVCOMM", "B-WELLS", "B-WEST", "EA-ARCHIVES", "EA-ATHL", "I-ARCHIVES", "I-DENT", "I-LIBR-SCA", "I-RAYBRAD",
  ...
  def self.ads_groups
    ["BL-LDLP-MDPI-MANAGERS-B-AAAI", "BL-LDLP-MDPI-MANAGERS-B-AAAMC", "BL-LDLP-MDPI-MANAGERS-B-AFRIST", "BL-LDLP-MDPI-MANAGERS-B-ALF",
     ...
     "BL-LDLP-MDPI-MANAGERS-B-ATHBASKW", "BL-LDLP-MDPI-MANAGERS-B-ATHFHOCKEY", "BL-LDLP-MDPI-MANAGERS-B-ATHFTBL", "BL-LDLP-MDPI-MANAGERS-B-ATHROWING",
     "BL-LDLP-MDPI-MANAGERS-B-ATHSOCCM", "BL-LDLP-MDPI-MANAGERS-B-ATHSOFTB", "BL-LDLP-MDPI-MANAGERS-B-ATHTENNM", "BL-LDLP-MDPI-MANAGERS-B-ATHVIDEO",
     "BL-LDLP-MDPI-MANAGERS-B-ATHVOLLW", "BL-LDLP-MDPI-MANAGERS-B-ATM", "BL-LDLP-MDPI-MANAGERS-B-BCC", "BL-LDLP-MDPI-MANAGERS-B-BFCA",
     "BL-LDLP-MDPI-MANAGERS-B-BUSSPEA", "BL-LDLP-MDPI-MANAGERS-B-CAC", "BL-LDLP-MDPI-MANAGERS-B-CDEL", "BL-LDLP-MDPI-MANAGERS-B-CEDIR",
     "BL-LDLP-MDPI-MANAGERS-B-CELCAR", "BL-LDLP-MDPI-MANAGERS-B-CELTIE", "BL-LDLP-MDPI-MANAGERS-B-CEUS", "BL-LDLP-MDPI-MANAGERS-B-CHEM",
     "BL-LDLP-MDPI-MANAGERS-B-CISAB", "BL-LDLP-MDPI-MANAGERS-B-CLACS", "BL-LDLP-MDPI-MANAGERS-B-CMCL", "BL-LDLP-MDPI-MANAGERS-B-CREOLE",
     "BL-LDLP-MDPI-MANAGERS-B-CSHM", "BL-LDLP-MDPI-MANAGERS-B-CYCLOTRN", "BL-LDLP-MDPI-MANAGERS-B-EASC", "BL-LDLP-MDPI-MANAGERS-B-EDUC",
     "BL-LDLP-MDPI-MANAGERS-B-EPPLEY", "BL-LDLP-MDPI-MANAGERS-B-FACILITY", "BL-LDLP-MDPI-MANAGERS-B-FINEARTS", "BL-LDLP-MDPI-MANAGERS-B-FOLKETHNO",
     ...
     "BL-LDLP-MDPI-MANAGERS-B-IAUNRC", "BL-LDLP-MDPI-MANAGERS-B-IBHA", "BL-LDLP-MDPI-MANAGERS-B-IPRC", "BL-LDLP-MDPI-MANAGERS-B-IUAM", "BL-LDLP-MDPI-MANAGERS-B-IULMIA",
     "BL-LDLP-MDPI-MANAGERS-B-JOURSCHL", "BL-LDLP-MDPI-MANAGERS-B-KINSEY", "BL-LDLP-MDPI-MANAGERS-B-LACASA", "BL-LDLP-MDPI-MANAGERS-B-LAW",
