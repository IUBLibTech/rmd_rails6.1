...
ActiveRecord::Schema.define(version: 2022_01_12_150257) do
  ...
  create_table "avalon_item_notes", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "avalon_item_people", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "person_id"
  ...
  create_table "avalon_item_works", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "avalon_item_id"
    t.bigint "work_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "avalon_items", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.text "title", null: false
    t.string "avalon_id", null: false
  ...
  create_table "iu_affiliations", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "nationalities", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "past_access_decisions", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "avalon_item_id"
    t.string "decision"
    t.string "changed_by"
    t.datetime "created_at", null: false
  ...
  create_table "performance_contributor_people", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "performance_notes", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "performances", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "work_id"
    t.string "location"
  ...
  create_table "person_iu_affiliations", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "person_id"
  ...
  create_table "person_nationalities", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "person_id"
  ...
  create_table "pod_objects", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "pod_physical_objects", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "pod_pulls", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.datetime "pull_timestamp", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "pod_workflow_statuses", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "policies", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "begin_date"
    t.date "end_date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "recording_contributor_people", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "contract_id"
  ...
  create_table "recording_notes", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "recording_performances", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "recording_id"
    t.bigint "performance_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "recording_take_down_notices", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "recording_id"
  ...
  create_table "recordings", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.text "title"
    t.text "description"
  ...
  create_table "review_comments", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "avalon_item_id"
    t.string "creator", null: false
  ...
  create_table "take_down_notices", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "track_contributor_people", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "track_id"
    t.bigint "person_id"
    t.string "role"
    t.datetime "created_at", null: false
  ...
  create_table "track_works", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "track_id"
    t.bigint "work_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "tracks", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "performance_id", null: false
  ...
  create_table "work_contributor_people", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.bigint "work_id"
    t.bigint "person_id"
    t.bigint "role_id"
    t.datetime "created_at", null: false
